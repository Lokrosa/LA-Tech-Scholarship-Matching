...
<div class="edits">
<h2 style="color: #000058;">Edit Scholarship</h2>
<hr>
<table id="main" summary="This is a sortable list for all tutorials located on all sites." class="sortable">
  <caption>Please chose the scholarship you want to edit:</caption>
  <thead>
    <tr>
      <th>Name</th>
      <th class="">Term</th>
  ...
  <tr>
    <td><a href="../edit2/">Example Scholarship 1</a></td>
    <td>Fall 2015</td>
  ...
  <tr>
    <td><a href="../edit2/">Example Scholarship 2</a> </td>
    <td>Spring 2015</td>
    <td>Engineering and Science</td>
    <td>graduate student</td>
  </tr>
